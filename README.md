...
|:-------:|:-----|:------------|
|0.5|ReflectiveLoader-v0_5.c| Added HellsGate & HalosGate direct syscaller, replaced allot of ASM stubs, code refactor, ~500 bytes smaller. And of course credit to @SEKTOR7net the jedi HalosGate creator & @smelly__vx & @am0nsec Creators/Publishers of the Hells Gate technique! Credit to @AustinNeely for recommending removing ASM Stubs! Haven't got all of them, but will keep working at it :) |
